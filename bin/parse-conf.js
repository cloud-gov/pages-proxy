...
function parseEnv({
  INCLUDE_SUBDOMAINS,
  PAGES_PROXY_SERVER_NAME,
  INTEGRATION,
  DEDICATED_S3_BUCKET,
  SHARED_S3_BUCKET,
  S3_ENDPOINT,
  MOCK_DEDICATED_S3_BUCKET_URL,
  MOCK_FEDERALIST_S3_BUCKET_URL,
  PROXY_WWW: HOME,
  PROXY_PORT,
  DNS_RESOLVER,
  DOMAIN
  ...
  return {
    INCLUDE_SUBDOMAINS,
    DEDICATED_S3_BUCKET_URL: INTEGRATION
      ? `https://${DEDICATED_S3_BUCKET}.${S3_ENDPOINT}`
      : MOCK_DEDICATED_S3_BUCKET_URL,
    PAGES_PROXY_SERVER_NAME,
    FEDERALIST_S3_BUCKET_URL: INTEGRATION
      ? `https://${SHARED_S3_BUCKET}.${S3_ENDPOINT}`
      : MOCK_FEDERALIST_S3_BUCKET_URL,
    HOME,
    PROXY_PORT,
    DNS_RESOLVER,
